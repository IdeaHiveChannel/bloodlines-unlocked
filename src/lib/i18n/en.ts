    ...
    list: [
      ...
      },
      {
        ...
        info: {
          ...
          diagnosis: [
            "Ultrasound mapping",
            "Fine needle aspiration (FNA) to confirm benign status",
            "Thyroid function tests"
          ],
          treatment: [
            "Local anaesthetic to the neck area.",
            "A thin electrode is guided into the nodule under ultrasound.",
            "Thermal energy shrinks the nodule tissue.",
      ...
      },
      {
        ...
        info: {
          symptoms: [
            ...
            "Pain not fully relieved by medication or physical therapy"
          ],
          causes: [
            "Knee osteoarthritis",
            "Chronic inflammation of the knee lining (synovitis)"
          ],
          diagnosis: [
            "Clinical evaluation of knee pain",
            "X-ray or MRI showing osteoarthritis",
            "Trial of conservative management"
          ],
          treatment: [
            "Small access in the groin or wrist.",
            "Navigating a microcatheter to the knee arteries.",
            "Releasing tiny particles to block small, abnormal vessels.",
      ...
      },
      {
        ...
        info: {
          symptoms: [
            "Decreased 'thrill' or buzz over the fistula",
            "Problems during dialysis (high venous pressures, poor flow)",
            "Swelling of the arm",
            "Prolonged bleeding after dialysis needle removal"
          ],
          causes: [
            "Stenosis (narrowing) of the fistula or outflow vein",
            "Repeated needle punctures",
            "Blood clots"
          ],
          diagnosis: [
            "Clinical examination",
            "Doppler ultrasound of the fistula",
            "Fistulogram (X-ray with contrast)"
          ],
          treatment: [
            "Direct puncture of the dialysis fistula.",
            "Passing a wire and balloon across the narrowing.",
            "High-pressure balloon inflation to open the vein.",
            "Restoring adequate flow for dialysis."
          ],
          recovery: [
            "Short observation period.",
            "The fistula can often be used for the next dialysis session.",
            "Minimal discomfort at the puncture site.",
            "Avoid heavy lifting with the access arm for 24 hours."
          ]
        }
      },
      {
        ...
        info: {
          ...
          diagnosis: [
            "Ultrasound of the liver and portal system",
            "Endoscopy to check for varices",
            "Liver function tests",
            "CT or MRI scan"
          ],
          treatment: [
            "Access through a neck vein.",
            "Creating a tunnel through the liver.",
            "Placing a covered stent to connect the portal and hepatic veins.",
            "Internal bypass to reduce pressure."
          ],
          recovery: [
            "2-3 days in the hospital for monitoring.",
            "Close follow-up for liver function and shunt patency.",
      ...
      },
      {
        ...
        info: {
          ...
          treatment: [
            "Access via a tiny puncture in the wrist or groin.",
            "Navigating a microcatheter to the small prostate arteries.",
            "Releasing embolic particles to shrink the gland.",
      ...
      },
      {
        ...
        info: {
          ...
          treatment: [
            "A small puncture in the groin or wrist.",
            "Navigating to the uterine arteries.",
            "Blocking the blood supply to the fibroids.",
            "The uterus is preserved while the fibroids shrink."
          ],
          recovery: [
            "Usually overnight stay in the hospital.",
            "Management of cramping pain for a few days.",
            "Return to normal activities in 1-2 weeks.",
            "Significant symptom relief by the second or third cycle."
          ]
        }
      }
    ]
