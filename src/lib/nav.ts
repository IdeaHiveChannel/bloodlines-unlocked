...
const treatCategories: NavLink[] = [
  ...
  { to: "/diseases/hepatocellular-carcinoma", label: "Liver tumours" },
  { to: "/diseases/renal-artery-stenosis", label: "Kidney blood vessels" },
  ...
  { to: "/diseases/dialysis-access-maintenance", label: "Dialysis access" },
...
const treatmentCategories: NavLink[] = [
  ...
  { to: "/diseases/brain-avm", label: "Brain vessel treatment" },
