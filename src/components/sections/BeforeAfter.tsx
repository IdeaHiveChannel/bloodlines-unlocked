  ...
  return (
    <section className="relative bg-[#050B16] py-32">
      <div className="mx-auto max-w-[1480px] px-6 sm:px-10">
        <p className="text-mono-label">Evidence</p>
        ...
        <div ref={ref}
          ...
          <div className="absolute top-4 left-4 text-mono-label bg-black/40 px-3 py-1 rounded-full">Before</div>
          <div className="absolute top-4 right-4 text-mono-label bg-black/40 px-3 py-1 rounded-full">After</div>
        </div>
      </div>
    </section>
  );
