...
export function ContactDock() {
  const t = useT();
  return (
    <div data-contact-dock className="fixed right-0 bottom-0 z-[60] flex flex-col items-end gap-2.5 p-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] sm:p-6 lg:p-8">
