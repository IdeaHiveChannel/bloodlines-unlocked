...
const hotspots: Hotspot[] = [
  ...
  },
  {
    ...
    organ: (
      <g>
        <path d="M200,140 L200,178 C200,196 210,204 210,222 L210,250" />
        <path d="M200,152 L182,142" />
        <path d="M200,152 L218,142" />
      </g>
    ),
  },
  {
                ...
                {hotspots.map((h) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        {tx(regionLabels[h.id]) === " " ? "'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            It is not visible" : tx(regionLabels[h.id])}
                      </text>
                    </g>
                  );
                })}
