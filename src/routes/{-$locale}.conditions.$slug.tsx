...
export const Route = createFileRoute("/{-$locale}/conditions/$slug")({
  head: ({ params }) => {
    ...
    const url = `${SITE}${localePath(`/conditions/${p.slug}`, locale)}`;
    return {
      meta: [
        ...
        },
        {
          ...
          children: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 2, name: "What I treat", item: `${SITE}${localePath("/conditions", locale)}` },
  ...
  notFoundComponent: () => (
    <div className="flex min-h-screen items-center justify-center px-6">
      <div className="text-center">
        ...
        <LocaleLink to="/conditions" className="mt-8 inline-block underline" data-cursor="link">
          All conditions
        </LocaleLink>
      </div>
    </div>
